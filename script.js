...
function resetGame() {
    ...
    document.getElementById("number-display").textContent = "00";
    document.getElementById("message").textContent = "";

    // Rimuovere l'animazione di fadeIn
    const numberDisplay = document.getElementById("number-display");
    numberDisplay.classList.remove("fadeIn");
    void numberDisplay.offsetWidth; // Trucchi per forzare la rimozione e riapplicazione della classe
